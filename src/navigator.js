...
window.addEventListener('scroll',(e)=>{
    ...
    if(clientHeight+scrollTop+50>= scrollHeight && location.hash.startsWith('#trends')) {
        console.log('bottom')
        return  trendPage()
    } 
    
    if(clientHeight+scrollTop+50>= scrollHeight && location.hash.startsWith('#category=')){
        console.log('bottom')
        return categoriesPage();
    }

    if(clientHeight+scrollTop+50>= scrollHeight && location.hash.startsWith('#search=')){
        console.log('bottom')
        return searchPage();
    }
